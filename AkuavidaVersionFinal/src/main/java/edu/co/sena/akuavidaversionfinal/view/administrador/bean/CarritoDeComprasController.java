...
import edu.co.sena.akuavidaversionfinal.controlller.administrador.beans.CarritoDeComprasFacade;
...
public class CarritoDeComprasController implements Serializable {
    ...
    @EJB
    private edu.co.sena.akuavidaversionfinal.controlller.administrador.beans.CarritoDeComprasFacade ejbFacade;
